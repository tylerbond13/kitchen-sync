...
class Game {
  constructor(level, roster, opts = {}) {
    ...
    // Owning the Auto-Chopper now keeps it on for the whole round — it's a pure
    // speed boost the crew paid for, so there's no reason to toggle it off. The
    // legacy opts.autoChop / 'autochop' socket switch is ignored.
